section .data
x db 1,2,2,3;			remember the sum of elements in the array should be less than 9
sum dw 1 ;			dw cuz result is stored in 16 bits or we can use db and assign 2 bytes to it
